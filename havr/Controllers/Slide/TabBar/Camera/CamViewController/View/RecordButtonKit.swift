...
public class RecordButtonKit : NSObject {
    ...
    private struct Cache {
        ...
        static let recordFrameColor: UIColor = Color.purpleColor
    ...
    public dynamic class var recordFrameColor: UIColor { return Color.purpleColor }
    public dynamic class var recordButtonNormalColor: UIColor { return Cache.recordButtonNormalColor }

    //// Drawing Methods

    public dynamic class func drawRecordButton(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 100, height: 100), resizing: ResizingBehavior = .aspectFit, recordButtonFrameColor: UIColor = Color.purpleColor, isRecording: CGFloat = 1, isPressed: Bool = false) {
