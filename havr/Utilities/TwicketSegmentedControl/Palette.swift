...
struct Palette {
    static let defaultTextColor = Apperance.textGrayColor
    static let highlightTextColor = UIColor.white
    static let segmentedControlBackgroundColor = UIColor.white
    static let sliderColor = Apperance.appBlueColor
