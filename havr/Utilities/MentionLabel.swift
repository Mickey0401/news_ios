...
public protocol MentionLabelDelegate: class {
...
@IBDesignable open class MentionLabel: UILabel {
    
    // MARK: - public properties
    open weak var delegate: MentionLabelDelegate?
    ...
    @IBInspectable open var mentionColor: UIColor = Apperance.appBlueColor {
    ...
    // MARK: - customzation
    @discardableResult
    open func customize(_ block: (_ label: MentionLabel) -> ()) -> MentionLabel {
        _customizing = true
        block(self)
        _customizing = false
        updateTextStorage()
...
extension MentionLabel: UIGestureRecognizerDelegate {
