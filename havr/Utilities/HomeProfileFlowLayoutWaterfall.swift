...
//public let CollectionViewWaterfallElementKindSectionHeader = "UICollectionElementKindSectionHeader"
...
open class CollectionViewWaterfallLayout: UICollectionViewLayout {
    ...
    func itemWidth() -> CGFloat {
        ...
        return ((width - self.sectionInset.left * 3) / 3) - 2
    }
